...
def alexnet(img_size_x, img_size_y, weight_path):
    net_data = np.load(open(weight_path, "rb"), encoding="latin1", allow_pickle=True).item()
    x = layers.Input(shape=(img_size_x, img_size_y, 3))
    ...
    return x, fc8 #inputs and outputs
    # prob
    # softmax(name='prob'))
